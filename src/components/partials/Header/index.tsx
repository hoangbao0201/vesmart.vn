...
export default function Header({ isDynamic }: HeaderProps) {
  ...
  return (
    <>
      <header className="bg-gradient-to-r from-slate-800 to-slate-700 border-b border-slate-800 sticky top-0 z-40">
        <div className="border-b border-slate-700 bg-gradient-to-r from-slate-800 to-slate-700 text-white">
